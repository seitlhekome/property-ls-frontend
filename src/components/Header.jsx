                ...
                <>
                  {isAgent ? (
                    <>
                      ...
                      <button
                        onClick={() =>
                          setShowListModal && setShowListModal(true)
                        }
                        className={secondaryButtonClass}
                      >
                        List Property
          ...
          <div className="mx-auto flex max-w-md items-center justify-between gap-3 rounded-2xl border border-gray-200 bg-white p-4 shadow-2xl">
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs text-gray-500">
                Faster access and a better experience.
              </p>
            </div>
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <button
                ...
                className="rounded-full px-2 py-1 text-xl leading-none text-gray-400 transition hover:bg-gray-100 hover:text-gray-600"
