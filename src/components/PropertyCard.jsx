      ...
      <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur">
        <div className="mx-auto grid h-[64px] max-w-7xl grid-cols-[42px_1fr_42px] items-center px-4 sm:h-[68px] sm:grid-cols-[44px_1fr_44px] sm:px-6">
          ...
          <div ref={menuRef} className="relative justify-self-start">
            ...
            {showMenu && (
              <div className="absolute left-0 top-11 z-[90] w-64 rounded-2xl border border-gray-200 bg-white p-2 shadow-2xl sm:top-12">
                <button
                  type="button"
          ...
          <div ref={accountRef} className="relative justify-self-end">
            ...
            {currentUser && showAccountMenu && (
              <div className="absolute right-0 top-11 z-[90] w-64 rounded-2xl border border-gray-200 bg-white p-2 shadow-2xl sm:top-12">
          ...
          <div className="mx-auto max-w-5xl px-4 pb-2.5 pt-2.5 sm:px-6 sm:pb-4 sm:pt-4">
            ...
            <div className="mx-auto mt-2.5 flex w-full max-w-[360px] items-center justify-center gap-2 sm:mt-3 sm:grid sm:max-w-[620px] sm:grid-cols-[92px_minmax(0,1fr)_92px] sm:gap-3">
              ...
              <div ref={filterRef} className="relative shrink-0">
                ...
                {showFilters && (
                  <div className="fixed left-4 right-4 top-[118px] z-[100] max-h-[calc(100vh-8.5rem)] overflow-y-auto rounded-2xl border border-gray-200 bg-white p-4 shadow-2xl sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:max-h-none sm:w-[520px] sm:overflow-visible sm:p-5">
